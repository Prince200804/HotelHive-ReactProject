      ...
      <footer>
        <div className='container grid'>
          ...
          <div className='box'>
            ...
            <input type='text' name='submit' id='submit-btn' className="sub-text" value={inputValue}
        onChange={handleChange}/>
            <input type="submit" onClick={handleSubmit}  for="submit" name='submit' id='submit-btn' className='primary-btn' value='SUBSCRIBE' />
